...
try {
  console.log(a + b);
  console.log(value); // 여기에서 value가 정의되지 않았다는 안내는 아래의 err 에 들어가게 됨
} catch (err) {
  console.log(err.name);
  console.log(err.message);
}

//JavaScript Object Notation 자바스크립트의 문자 표기법
...
//현재 서버에서 데이터가 넘어온 상태라고 생각하면 됨.(typeof data 가 string이기 때문에)

//console.log(JSON.parse(data)); //서버로부터 받은 string을 객체화함.
